...
# Reading Goal
    ...
    goal = st.number_input("Set a yearly reading goal", min_value=1, step=1)
...
st.markdown("---")
st.markdown("<p style='text-align: center; color: gray;'>© 2025 Library Manager | Developed with ❤️ by Ayesha</p>", unsafe_allow_html=True)